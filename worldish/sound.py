...
if specific.soundOn:
        ...
        # Sound-related submodules.
        from . import background_sound as backgroundSound
#       import csnd_interface as csndInterface
        ...
        def startSoundServer():
                ...
                """
                soundGlobals.mainIterCycle = 1
                soundGlobals.stop_event.clear()
        ...
        def backgroundVoices():
                ...
                frstInstr = 2
                frstInstrLst = list(range(frstInstr, (backgroundPartials + frstInstr) * 2,
                                                        backgroundPartials))
...
def beginPerformance():
        """Start audio after generated agents have finished compiling."""
        if specific.soundOn:
                SoundServer.play()
