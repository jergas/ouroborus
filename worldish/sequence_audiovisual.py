...
def startExecutionNormal():
        ...
        try:
                if specific.displayType in ('pygame', 'debug'):
                        main(None)
...
def main(stdscr):
        ...
        if stdscr:
                ...
                display = aset.generateDisplay(kemet, size, taw)
        ...
        try:
                ...
                while bast.annum < doomsday:
                        ...
                        for entry in list(taw.values()):
                                ...
                                if not bast.annum % simulationToAudiovisual:
                                        ...
                                        # sound
                                        if specific.soundOn and entry.fatum["prayer"] == "BeBirthed":
                                ...
                                if not bast.annum % simulationToAudiovisual:
                                        ...
                                        if specific.soundOn and entry.fatum["voice"].ate == 1:
                ...
                for voice in backgroundVoices + [backgroundControl]:
                        voice.join()
                sound.stopSoundServer()
        runtime.report_result(bast, aset)
        del sys.argv[1:]
        print("Done.")
        return 1
