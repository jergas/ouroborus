...
# and manifest the agents on the grid
creaturedepth = 70
creatures = []

def birthAgents(number, cast):
	for i in range(number):
		entity = amatheon.beBorn(annuvin)
		prydain.addAgent(entity)
		cast.append(entity)
		
	
birthAgents(creaturedepth, creatures)
...
def main(stdscr):
    ...
    v.updateLoopTranslucent(prydain, stdscr, displaywidth, displayheight)
    stdscr.refresh()
