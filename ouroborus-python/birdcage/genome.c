/* Generated by Pyrex 0.9.6.4 on Wed May  7 14:42:18 2008 */
...
static int __pyx_f_6genome_6Genome___init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/edgar/Desktop/birdcage0.5.4/genome.pyx":40 */
  Py_INCREF(__pyx_v_text);
  ...
  /* "/home/edgar/Desktop/birdcage0.5.4/genome.pyx":41 */
  Py_INCREF(__pyx_v_table);
  ...
  /* "/home/edgar/Desktop/birdcage0.5.4/genome.pyx":42 */
...
static PyObject *__pyx_f_6genome_6Genome_pyx_readWord(struct __pyx_obj_6genome_Genome *__pyx_v_self,int __pyx_v_index) {
  ...
  /* "/home/edgar/Desktop/birdcage0.5.4/genome.pyx":53 */
  Py_INCREF(__pyx_k2p);
  Py_DECREF(__pyx_v_word);
  __pyx_v_word = __pyx_k2p;

  /* "/home/edgar/Desktop/birdcage0.5.4/genome.pyx":55 */
  ...
  for (;;) {
    ...
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    __pyx_v_i = __pyx_4;
    __pyx_2 = PyInt_FromLong((__pyx_v_index + __pyx_v_i)); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; goto __pyx_L1;}
    __pyx_3 = PyObject_GetItem(__pyx_v_self->text, __pyx_2); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; goto __pyx_L1;}
    Py_DECREF(__pyx_2); __pyx_2 = 0;
    __pyx_2 = PyNumber_Add(__pyx_v_word, __pyx_3); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; goto __pyx_L1;}
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    Py_DECREF(__pyx_v_word);
  ...
  /* "/home/edgar/Desktop/birdcage0.5.4/genome.pyx":58 */
...
static PyObject *__pyx_f_6genome_6Genome_pyx_parse(struct __pyx_obj_6genome_Genome *__pyx_v_self) {
  ...
  /* "/home/edgar/Desktop/birdcage0.5.4/genome.pyx":85 */
  Py_INCREF(__pyx_k3p);
  Py_DECREF(__pyx_v_code);
  __pyx_v_code = __pyx_k3p;

  /* "/home/edgar/Desktop/birdcage0.5.4/genome.pyx":87 */
  ...
  /* "/home/edgar/Desktop/birdcage0.5.4/genome.pyx":90 */
...
static PyObject *__pyx_f_6genome_6Genome_incorporate(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/edgar/Desktop/birdcage0.5.4/genome.pyx":96 */
  __pyx_1 = __Pyx_GetName(__pyx_b, __pyx_n_open); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; goto __pyx_L1;}
  ...
  __pyx_v_body = __pyx_3;
  __pyx_3 = 0;

  /* "/home/edgar/Desktop/birdcage0.5.4/genome.pyx":97 */
  ...
  /* "/home/edgar/Desktop/birdcage0.5.4/genome.pyx":98 */
  __pyx_3 = PyObject_GetAttr(__pyx_v_body, __pyx_n_write); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 98; goto __pyx_L1;}
  ...
  /* "/home/edgar/Desktop/birdcage0.5.4/genome.pyx":99 */
  __pyx_3 = PyObject_GetAttr(__pyx_v_body, __pyx_n_close); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; goto __pyx_L1;}
  __pyx_1 = PyObject_CallObject(__pyx_3, 0); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; goto __pyx_L1;}
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  Py_DECREF(__pyx_1); __pyx_1 = 0;
...
PyMODINIT_FUNC initgenome(void) {
  ...
  *(void(**)(void))&__pyx_vtable_6genome_Genome.pyx_parse = (void(*)(void))__pyx_f_6genome_6Genome_pyx_parse;
  ...
  /* "/home/edgar/Desktop/birdcage0.5.4/genome.pyx":20 */
  ...
  /* "/home/edgar/Desktop/birdcage0.5.4/genome.pyx":93 */
  return;
  __pyx_L1:;
  Py_XDECREF(__pyx_1);
