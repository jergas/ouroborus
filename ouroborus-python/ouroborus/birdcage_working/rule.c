/* Generated by Pyrex 0.9.6.4 on Wed Jan 16 12:49:29 2008 */
...
static int __pyx_f_4rule_7Rule_2D___init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_neighborhood), __pyx_ptype_12neighborhood_Neighborhood_2D, 1, "neighborhood")) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; goto __pyx_L1;}

  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":41 */
  ...
  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":42 */
  Py_INCREF(__pyx_v_param);
  ...
  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":43 */
  Py_INCREF(__pyx_k4p);
...
static PyObject *__pyx_f_4rule_7Rule_2D_apply(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":61 */
  __pyx_1 = PyObject_Length(__pyx_v_address); if (__pyx_1 == -1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; goto __pyx_L1;}
  __pyx_2 = (!(__pyx_1 == 2));
  if (__pyx_2) {
    __pyx_3 = __Pyx_GetName(__pyx_m, __pyx_n_E); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; goto __pyx_L1;}
    __pyx_4 = PyObject_GetAttr(__pyx_3, __pyx_n_InvalidAddressError); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; goto __pyx_L1;}
    ...
    __pyx_5 = PyObject_CallObject(__pyx_4, __pyx_3); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; goto __pyx_L1;}
  ...
  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":64 */
  __pyx_4 = PyInt_FromLong(0); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; goto __pyx_L1;}
  __pyx_3 = PyObject_GetItem(__pyx_v_address, __pyx_4); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; goto __pyx_L1;}
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  __pyx_2 = PyInt_AsLong(__pyx_3); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; goto __pyx_L1;}
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  __pyx_5 = PyInt_FromLong(1); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; goto __pyx_L1;}
  __pyx_4 = PyObject_GetItem(__pyx_v_address, __pyx_5); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; goto __pyx_L1;}
  Py_DECREF(__pyx_5); __pyx_5 = 0;
  __pyx_6 = PyInt_AsLong(__pyx_4); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; goto __pyx_L1;}
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  __pyx_3 = ((struct __pyx_vtabstruct_4rule_Rule_2D *)((struct __pyx_obj_4rule_Rule_2D *)__pyx_v_self)->__pyx_vtab)->pyx_apply(((struct __pyx_obj_4rule_Rule_2D *)__pyx_v_self),__pyx_2,__pyx_6); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; goto __pyx_L1;}
  Py_DECREF(__pyx_3); __pyx_3 = 0;
...
static PyObject *__pyx_f_4rule_7Rule_2D_applyToTarget(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_target), __pyx_ptype_8topology_GridTopology, 1, "target")) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 77; goto __pyx_L1;}

  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":86 */
  __pyx_1 = PyObject_Length(__pyx_v_address); if (__pyx_1 == -1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 86; goto __pyx_L1;}
  __pyx_2 = (!(__pyx_1 == 2));
  if (__pyx_2) {
    __pyx_3 = __Pyx_GetName(__pyx_m, __pyx_n_E); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; goto __pyx_L1;}
    __pyx_4 = PyObject_GetAttr(__pyx_3, __pyx_n_InvalidAddressError); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; goto __pyx_L1;}
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    ...
    Py_INCREF(((struct __pyx_obj_4rule_Rule_2D *)__pyx_v_self)->neighborhood->topology->__pyx_base.name);
    PyTuple_SET_ITEM(__pyx_3, 1, ((struct __pyx_obj_4rule_Rule_2D *)__pyx_v_self)->neighborhood->topology->__pyx_base.name);
    __pyx_5 = PyObject_CallObject(__pyx_4, __pyx_3); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; goto __pyx_L1;}
    Py_DECREF(__pyx_4); __pyx_4 = 0;
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    __Pyx_Raise(__pyx_5, 0, 0);
    Py_DECREF(__pyx_5); __pyx_5 = 0;
  ...
  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":89 */
  __pyx_4 = PyInt_FromLong(0); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; goto __pyx_L1;}
  __pyx_3 = PyObject_GetItem(__pyx_v_address, __pyx_4); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; goto __pyx_L1;}
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  ...
  __pyx_4 = PyObject_GetItem(__pyx_v_address, __pyx_5); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; goto __pyx_L1;}
  Py_DECREF(__pyx_5); __pyx_5 = 0;
  __pyx_6 = PyInt_AsLong(__pyx_4); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; goto __pyx_L1;}
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  __pyx_3 = ((struct __pyx_vtabstruct_4rule_Rule_2D *)((struct __pyx_obj_4rule_Rule_2D *)__pyx_v_self)->__pyx_vtab)->pyx_applyToTarget(((struct __pyx_obj_4rule_Rule_2D *)__pyx_v_self),__pyx_2,__pyx_6,__pyx_v_target); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; goto __pyx_L1;}
  Py_DECREF(__pyx_3); __pyx_3 = 0;
...
static int __pyx_f_4rule_13ReductionRule___init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  Py_INCREF(__pyx_v_neighborhood);
  Py_INCREF(__pyx_v_param);
  if (!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_neighborhood), __pyx_ptype_12neighborhood_Neighborhood_2D, 1, "neighborhood")) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 113; goto __pyx_L1;}

  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":121 */
  __pyx_1 = PyObject_GetAttr(((PyObject*)__pyx_ptype_4rule_Rule_2D), __pyx_n___init__); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 121; goto __pyx_L1;}
  __pyx_2 = PyTuple_New(3); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 121; goto __pyx_L1;}
  Py_INCREF(__pyx_v_self);
  ...
  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":122 */
  Py_INCREF(__pyx_k5p);
...
static PyObject *__pyx_f_4rule_13ReductionRule_pyx_apply(struct __pyx_obj_4rule_ReductionRule *__pyx_v_self,int __pyx_v_x1,int __pyx_v_x2) {
  ...
  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":134 */
  __pyx_1 = PyInt_FromLong(0); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 134; goto __pyx_L1;}
  __pyx_2 = PyObject_GetItem(__pyx_v_self->__pyx_base.param, __pyx_1); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 134; goto __pyx_L1;}
  Py_DECREF(__pyx_1); __pyx_1 = 0;
  __pyx_1 = PyInt_FromLong(1); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 134; goto __pyx_L1;}
  __pyx_3 = PyObject_GetItem(__pyx_v_self->__pyx_base.param, __pyx_1); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 134; goto __pyx_L1;}
  Py_DECREF(__pyx_1); __pyx_1 = 0;
  __pyx_4 = PyInt_AsLong(__pyx_3); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 134; goto __pyx_L1;}
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  __pyx_v_state = ((struct __pyx_vtabstruct_12neighborhood_Neighborhood_2D *)__pyx_v_self->__pyx_base.neighborhood->__pyx_vtab)->pyx_reduceStates(__pyx_v_self->__pyx_base.neighborhood,__pyx_v_x1,__pyx_v_x2,__pyx_2,__pyx_4);
  Py_DECREF(__pyx_2); __pyx_2 = 0;

  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":135 */
...
static PyObject *__pyx_f_4rule_13ReductionRule_pyx_applyToTarget(struct __pyx_obj_4rule_ReductionRule *__pyx_v_self,int __pyx_v_x1,int __pyx_v_x2,struct __pyx_obj_8topology_GridTopology *__pyx_v_target) {
  ...
  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":150 */
  __pyx_1 = PyInt_FromLong(0); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 150; goto __pyx_L1;}
  __pyx_2 = PyObject_GetItem(__pyx_v_self->__pyx_base.param, __pyx_1); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 150; goto __pyx_L1;}
  Py_DECREF(__pyx_1); __pyx_1 = 0;
  __pyx_1 = PyInt_FromLong(1); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 150; goto __pyx_L1;}
  __pyx_3 = PyObject_GetItem(__pyx_v_self->__pyx_base.param, __pyx_1); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 150; goto __pyx_L1;}
  Py_DECREF(__pyx_1); __pyx_1 = 0;
  __pyx_4 = PyInt_AsLong(__pyx_3); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 150; goto __pyx_L1;}
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  __pyx_v_state = ((struct __pyx_vtabstruct_12neighborhood_Neighborhood_2D *)__pyx_v_self->__pyx_base.neighborhood->__pyx_vtab)->pyx_reduceStates(__pyx_v_self->__pyx_base.neighborhood,__pyx_v_x1,__pyx_v_x2,__pyx_2,__pyx_4);
  Py_DECREF(__pyx_2); __pyx_2 = 0;

  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":151 */
...
static int __pyx_f_4rule_10ConwayRule___init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  Py_INCREF(__pyx_v_neighborhood);
  Py_INCREF(__pyx_v_param);
  if (!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_neighborhood), __pyx_ptype_12neighborhood_Neighborhood_2D, 1, "neighborhood")) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 161; goto __pyx_L1;}

  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":168 */
  __pyx_1 = PyObject_GetAttr(((PyObject*)__pyx_ptype_4rule_Rule_2D), __pyx_n___init__); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 168; goto __pyx_L1;}
  __pyx_2 = PyTuple_New(3); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 168; goto __pyx_L1;}
  Py_INCREF(__pyx_v_self);
  PyTuple_SET_ITEM(__pyx_2, 0, __pyx_v_self);
  Py_INCREF(((PyObject *)__pyx_v_neighborhood));
  PyTuple_SET_ITEM(__pyx_2, 1, ((PyObject *)__pyx_v_neighborhood));
  ...
  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":169 */
  Py_INCREF(__pyx_k6p);
...
static PyObject *__pyx_f_4rule_10ConwayRule_pyx_apply(struct __pyx_obj_4rule_ConwayRule *__pyx_v_self,int __pyx_v_x1,int __pyx_v_x2) {
  ...
  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":181 */
  ...
  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":182 */
  ...
  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":183 */
  ...
  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":190 */
  ((struct __pyx_vtabstruct_8topology_GridTopology *)__pyx_v_self->__pyx_base.neighborhood->topology->__pyx_base.__pyx_vtab)->pyx_set(__pyx_v_self->__pyx_base.neighborhood->topology,__pyx_v_x1,__pyx_v_x2,__pyx_v_state);
...
static PyObject *__pyx_f_4rule_10ConwayRule_pyx_applyToTarget(struct __pyx_obj_4rule_ConwayRule *__pyx_v_self,int __pyx_v_x1,int __pyx_v_x2,struct __pyx_obj_8topology_GridTopology *__pyx_v_target) {
  ...
  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":205 */
  __pyx_v_sumstates = ((struct __pyx_vtabstruct_12neighborhood_Neighborhood_2D *)__pyx_v_self->__pyx_base.neighborhood->__pyx_vtab)->pyx_sumStates(__pyx_v_self->__pyx_base.neighborhood,__pyx_v_x1,__pyx_v_x2);

  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":206 */
  __pyx_v_cell = ((struct __pyx_vtabstruct_8topology_GridTopology *)__pyx_v_self->__pyx_base.neighborhood->topology->__pyx_base.__pyx_vtab)->pyx_get(__pyx_v_self->__pyx_base.neighborhood->topology,__pyx_v_x1,__pyx_v_x2);

  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":207 */
  __pyx_1 = (__pyx_v_cell == 0);
  if (__pyx_1) {
    __pyx_1 = (__pyx_v_sumstates == 3);
  }
  ...
  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":214 */
  ((struct __pyx_vtabstruct_8topology_GridTopology *)__pyx_v_target->__pyx_base.__pyx_vtab)->pyx_set(__pyx_v_target,__pyx_v_x1,__pyx_v_x2,__pyx_v_state);
...
static int __pyx_tp_traverse_4rule_ReductionRule(PyObject *o, visitproc v, void *a) {
  int e;
  e = __pyx_ptype_4rule_Rule_2D->tp_traverse(o, v, a); if (e) return e;
  return 0;
}

static int __pyx_tp_clear_4rule_ReductionRule(PyObject *o) {
  __pyx_ptype_4rule_Rule_2D->tp_clear(o);
  return 0;
}
...
PyTypeObject __pyx_type_4rule_ReductionRule = {
  ...
  __pyx_tp_traverse_4rule_ReductionRule, /*tp_traverse*/
  __pyx_tp_clear_4rule_ReductionRule, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
...
static int __pyx_tp_traverse_4rule_ConwayRule(PyObject *o, visitproc v, void *a) {
  int e;
  e = __pyx_ptype_4rule_Rule_2D->tp_traverse(o, v, a); if (e) return e;
  return 0;
}

static int __pyx_tp_clear_4rule_ConwayRule(PyObject *o) {
  __pyx_ptype_4rule_Rule_2D->tp_clear(o);
  return 0;
}
...
PyTypeObject __pyx_type_4rule_ConwayRule = {
  ...
  __pyx_tp_traverse_4rule_ConwayRule, /*tp_traverse*/
  __pyx_tp_clear_4rule_ConwayRule, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
...
PyMODINIT_FUNC initrule(void) {
  ...
  *(void(**)(void))&__pyx_vtable_4rule_Rule_2D.pyx_applyToTarget = (void(*)(void))__pyx_f_4rule_7Rule_2D_pyx_applyToTarget;
  ...
  if (PyType_Ready(&__pyx_type_4rule_Rule_2D) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; goto __pyx_L1;}
  if (__Pyx_SetVtable(__pyx_type_4rule_Rule_2D.tp_dict, __pyx_vtabptr_4rule_Rule_2D) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; goto __pyx_L1;}
  if (PyObject_SetAttrString(__pyx_m, "Rule_2D", (PyObject *)&__pyx_type_4rule_Rule_2D) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; goto __pyx_L1;}
  ...
  *(void(**)(void))&__pyx_vtable_4rule_ReductionRule.__pyx_base.pyx_applyToTarget = (void(*)(void))__pyx_f_4rule_13ReductionRule_pyx_applyToTarget;
  ...
  if (PyType_Ready(&__pyx_type_4rule_ReductionRule) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 108; goto __pyx_L1;}
  if (__Pyx_SetVtable(__pyx_type_4rule_ReductionRule.tp_dict, __pyx_vtabptr_4rule_ReductionRule) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 108; goto __pyx_L1;}
  if (PyObject_SetAttrString(__pyx_m, "ReductionRule", (PyObject *)&__pyx_type_4rule_ReductionRule) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 108; goto __pyx_L1;}
  ...
  *(void(**)(void))&__pyx_vtable_4rule_ConwayRule.__pyx_base.pyx_applyToTarget = (void(*)(void))__pyx_f_4rule_10ConwayRule_pyx_applyToTarget;
  ...
  if (PyType_Ready(&__pyx_type_4rule_ConwayRule) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; goto __pyx_L1;}
  if (__Pyx_SetVtable(__pyx_type_4rule_ConwayRule.tp_dict, __pyx_vtabptr_4rule_ConwayRule) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; goto __pyx_L1;}
  if (PyObject_SetAttrString(__pyx_m, "ConwayRule", (PyObject *)&__pyx_type_4rule_ConwayRule) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; goto __pyx_L1;}
  ...
  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":20 */
  ...
  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":34 */
  Py_INCREF(Py_None);
  __pyx_k2 = Py_None;

  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":161 */
  Py_INCREF(Py_None);
  __pyx_k3 = Py_None;

  /* "C:\Python25\Lib\site-packages\birdcage\rule.pyx":193 */
  return;
  __pyx_L1:;
  Py_XDECREF(__pyx_1);
